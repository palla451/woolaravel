...
Route::get('/woocommerce/{string}', 'ApiWooCommerce@index');
Route::get('/last_register/{string}','ApiWooCommerce@booking_lastUser');


Route::get('/connect', 'WordpressController@index');
Route::get('/myip', 'WordpressController@myIp');
