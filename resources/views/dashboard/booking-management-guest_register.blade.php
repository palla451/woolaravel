                            ...
                            <form id="search" action="{{ route('bookings.search') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" value="{{ $bookingTime }}" class="form-control pull-right" name="bookingTime" id="bookingTime">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>&nbsp;</label>
                                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target=".bd-example-modal-lg" style="width: 100%">Add Optional</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="title">Coffee Break</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">Quick Lunch</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">Videoproiettore</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">Permanent Coffee</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">Wi-Fi</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">videoconferenza</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">webconference</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">lavagna_foglimobili</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">stampante</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">permanent_coffeeplus</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">connessione_viacavo</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">integrazione_permanentcoffee</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">upgrade_banda10mb</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">upgrade_banda8mb</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">upgrade_banda20mb</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">wirless_4mb20accessi</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">wirless_8mb35accessi</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">wirless_10mb50accessi</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">videoregistrazione</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">fattorino</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="fattorino" autofocus>
                                <p class="errorContent text-center alert alert-danger hidden"></p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="content">lavagna_interattiva</label>
                            <div class="col-sm-10">
